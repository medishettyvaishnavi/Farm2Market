      ...
      <div className="container py-4">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted small mb-0 mt-1 d-flex align-items-center gap-1">
                ...
                {farmer?.village} • {farmer?.landSize}{" "}
                {farmer?.landUnit || "Acres"} Farm
              </p>
            </div>
          </div>
        ...
        <div className="card shadow-sm border-0 rounded-4 p-3 mb-4 bg-white">
          <div className="d-flex align-items-center justify-content-between mb-2">
            ...
            <Link
              to="/farmer/markets"
              className="small text-decoration-none text-success fw-bold"
            >
              {t("viewAll")} →
            </Link>
          </div>
          ...
          <div className="col-lg-6">
            <div className="card shadow-sm border-0 rounded-4 p-4 bg-white h-100">
              ...
              {crops.slice(0, 3).map((crop) => (
                <div
                  key={crop.id}
                  className="d-flex align-items-center justify-content-between p-3 rounded-3 bg-light mb-2 border"
                >
                  <div className="d-flex align-items-center gap-3">
                    <img
                      src={crop.photos[0]}
                    ...
                    <div>
                      ...
                      <span className="small text-muted">
                        {crop.quantity} {crop.unit} • Expected: ₹
                        {crop.expectedPrice.toLocaleString()}
                      </span>
                    </div>
                  </div>
          ...
          <div className="col-lg-6">
            <div className="card shadow-sm border-0 rounded-4 p-4 bg-white h-100">
              ...
              <div className="d-flex align-items-center justify-content-between mb-3">
                ...
                <Link
                  to="/farmer/offers"
                  className="btn btn-outline-warning text-dark btn-sm rounded-pill fw-bold"
                >
              ...
              {offers.slice(0, 2).map((offer) => (
                <div
                  key={offer.id}
                  className="p-3 rounded-3 bg-light mb-2 border"
                >
